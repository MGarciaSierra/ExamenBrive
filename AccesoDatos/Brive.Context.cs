...
namespace AccesoDatos
{
    ...
    public partial class BriveSucursalEntities : DbContext
    {
        public BriveSucursalEntities()
            : base("name=BriveSucursalEntities")
        {
        }
        ...
        public virtual int AgregarDetalleventa(Nullable<int> idVenta, Nullable<int> idSucursal, Nullable<int> cantidad, Nullable<int> idProducto)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AgregarDetalleventa", idVentaParameter, idSucursalParameter, cantidadParameter, idProductoParameter);
        }
    
        public virtual int AgregarVenta(Nullable<int> idUsuario, Nullable<decimal> total, Nullable<int> idMetodoPago, ObjectParameter idVenta)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AgregarVenta", idUsuarioParameter, totalParameter, idMetodoPagoParameter, idVenta);
        }
        ...
        public virtual int SucursalActualizar(Nullable<int> idSucursal, string nombre, string direccion, string telefono)
        {
            var idSucursalParameter = idSucursal.HasValue ?
                new ObjectParameter("IdSucursal", idSucursal) :
                new ObjectParameter("IdSucursal", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SucursalActualizar", idSucursalParameter, nombreParameter, direccionParameter, telefonoParameter);
        }
    
        public virtual int SucursalAgregar(string nombre, string direccion, string telefono)
        {
            var nombreParameter = nombre != null ?
                new ObjectParameter("Nombre", nombre) :
                new ObjectParameter("Nombre", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SucursalAgregar", nombreParameter, direccionParameter, telefonoParameter);
        }
    
        public virtual int SucursalEliminar(Nullable<int> idSucursal)
        {
            var idSucursalParameter = idSucursal.HasValue ?
                new ObjectParameter("IdSucursal", idSucursal) :
                new ObjectParameter("IdSucursal", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SucursalEliminar", idSucursalParameter);
        }
    
        public virtual ObjectResult<SucursalMostrar_Result> SucursalMostrar()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SucursalMostrar_Result>("SucursalMostrar");
        }
    
        public virtual ObjectResult<SucursalMostrarUno_Result> SucursalMostrarUno(Nullable<int> idSucursal)
        {
            var idSucursalParameter = idSucursal.HasValue ?
                new ObjectParameter("IdSucursal", idSucursal) :
                new ObjectParameter("IdSucursal", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SucursalMostrarUno_Result>("SucursalMostrarUno", idSucursalParameter);
        }
